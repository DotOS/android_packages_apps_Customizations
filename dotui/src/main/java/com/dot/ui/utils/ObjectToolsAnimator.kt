...
object ObjectToolsAnimator {
    ...
    fun animate(v: View, direction: String?, start: Float, end: Float, duration: Long) {
        val mover = ObjectAnimator.ofFloat(v, direction, start, end)
        mover.duration = duration
        mover.start()
    }
    ...
    fun animate(v: View, direction: String?, start: Float, end: Float) {
        val mover = ObjectAnimator.ofFloat(v, direction, start, end)
        mover.duration = 500
        mover.start()
    }
