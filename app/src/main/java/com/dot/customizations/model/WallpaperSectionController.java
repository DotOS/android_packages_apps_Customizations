...
import com.dot.customizations.picker.CategorySelectorFragment;
import com.dot.customizations.picker.MyPhotosStarter;
import com.dot.customizations.picker.WallpaperSectionView;
...
public class WallpaperSectionController implements
    ...
    public void onTransitionOut() {
        if (mHomeWallpaperSurface != null) {
            HiddenApiBypass.invoke(SurfaceView.class, mHomeWallpaperSurface, "setUseAlpha");
            mHomeWallpaperSurface.setAlpha(0f);
        }
        if (mLockWallpaperSurface != null) {
            HiddenApiBypass.invoke(SurfaceView.class, mLockWallpaperSurface, "setUseAlpha");
            mLockWallpaperSurface.setAlpha(0f);
        }
        if (mWorkspaceSurface != null) {
            HiddenApiBypass.invoke(SurfaceView.class, mWorkspaceSurface, "setUseAlpha");
