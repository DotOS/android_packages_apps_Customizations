 ...
 */
package com.dot.customizations.model.mode;
...
public class DarkModeSectionController implements
    ...
    public boolean isAvailable(Context context) {
        ...
        return ContextCompat.checkSelfPermission(context, "android.permission.MODIFY_DAY_NIGHT_MODE")
                == PERMISSION_GRANTED;
    }
    ...
    private void onViewActivated(Context context, boolean viewActivated) {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(
                () -> uiModeManager.setNightMode(viewActivated ? UiModeManager.MODE_NIGHT_YES : UiModeManager.MODE_NIGHT_NO),
