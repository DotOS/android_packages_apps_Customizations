...
import com.dot.customizations.picker.MasterSwitchFragment
...
open class PreferenceViewModel(app: Application) : AndroidViewModel(app) {

    open var preferencesAdapter: PreferencesAdapter? = null
    ...
    fun PreferenceScreen.Builder.fragmentMasterPreference(
        navigationController: CustomizationSectionController.CustomizationSectionNavigationController,
        switchTitle: CharSequence,
        dependencyName: String,
        dependencyDefault: Int = 0,
        dependencyType: MasterSwitchFragment.SettingsType = SYSTEM,
        screen: PreferenceScreen,
        block: Preference.() -> Unit
    ): Preference {
        val fragment = MasterSwitchFragment.Companion.Builder(
            switchTitle, dependencyName, dependencyDefault, dependencyType, screen
        ).getFragment()
