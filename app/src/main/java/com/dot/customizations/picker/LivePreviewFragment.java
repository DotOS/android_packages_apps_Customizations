...
import static com.dot.customizations.widget.BottomActionBar.BottomAction.CUSTOMIZE;
import static com.dot.customizations.widget.BottomActionBar.BottomAction.DELETE;
...
public class LivePreviewFragment extends PreviewFragment implements
    ...
    protected void setUpLiveWallpaperPreview(
            com.dot.customizations.model.WallpaperInfo homeWallpaper) {
        Activity activity = getActivity();
