...
import com.dot.customizations.config.Flags;
...
import com.dot.customizations.module.DailyLoggingAlarmScheduler;
import com.dot.customizations.module.ExploreIntentChecker;
...
import com.dot.customizations.module.NetworkStatusNotifier;
...
import com.dot.customizations.module.UserEventLogger.WallpaperSetFailureReason;
...
import com.dot.customizations.module.WallpaperPersister.WallpaperPosition;
...
import com.dot.customizations.module.WallpaperRotationRefresher;
import com.dot.customizations.module.WallpaperRotationRefresher.Listener;
...
public class TopLevelPickerActivity extends BaseActivity implements WallpapersUiContainer,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mDelegate.getFormFactor() == FormFactorChecker.FORM_FACTOR_MOBILE) {
            initializeMobile( /* shouldForceRefresh */);
        } else { // DESKTOP
    ...
    private void initializeDesktop(Bundle savedInstanceState) {
        ...
        mCurrentWallpaperImage = mBottomSheet.findViewById(R.id.current_wallpaper_image);
        mCurrentWallpaperImage.getLayoutParams().width = getSingleWallpaperImageWidthPx();

        mCurrentWallpaperPresentationMode =
                mBottomSheet.findViewById(R.id.current_wallpaper_presentation_mode);
        mCurrentWallpaperTitle = findViewById(R.id.current_wallpaper_title);
        mCurrentWallpaperSubtitle = findViewById(R.id.current_wallpaper_subtitle);
        mCurrentWallpaperExploreButton = findViewById(
                R.id.current_wallpaper_explore_button);
        mCurrentWallpaperSkipWallpaperButton = findViewById(
        ...
        mWallpaperPositionOptions = findViewById(
    ...
    private void initializeWallpaperPositionOptionClickHandlers(final WallpaperInfo wallpaperInfo) {
        Button centerCropOptionBtn = findViewById(R.id.wallpaper_position_option_center_crop);
        Button stretchOptionBtn = findViewById(R.id.wallpaper_position_option_stretched);
        Button centerOptionBtn = findViewById(R.id.wallpaper_position_option_center);
        ...
        centerCropOptionBtn.setOnClickListener(view -> mWallpaperPersister.setIndividualWallpaperWithPosition(TopLevelPickerActivity.this,
                wallpaperInfo, WallpaperPersister.WALLPAPER_POSITION_CENTER_CROP,
                new SetWallpaperCallback() {
                    @Override
                    public void onSuccess(WallpaperInfo wallpaperInfo1) {
        ...
        setStretchWallpaperPositionButtonSelected(stretchOptionBtn, false /* isSelected */);
        stretchOptionBtn.setOnClickListener(view -> mWallpaperPersister.setIndividualWallpaperWithPosition(TopLevelPickerActivity.this,
                wallpaperInfo, WallpaperPersister.WALLPAPER_POSITION_STRETCH,
                new SetWallpaperCallback() {
                    @Override
                    public void onSuccess(WallpaperInfo wallpaperInfo12) {
                        // The user may have closed the activity before the set wallpaper operation
                        // completed.
                        if (isDestroyed()) {
                            return;
        ...
        setCenterWallpaperPositionButtonSelected(centerOptionBtn, false /* isSelected */);
        centerOptionBtn.setOnClickListener(view -> mWallpaperPersister.setIndividualWallpaperWithPosition(TopLevelPickerActivity.this,
                wallpaperInfo, WallpaperPersister.WALLPAPER_POSITION_CENTER,
                new SetWallpaperCallback() {
                    @Override
                    public void onSuccess(WallpaperInfo wallpaperInfo13) {
                        // The user may have closed the activity before the set wallpaper operation
                        // completed.
                        if (isDestroyed()) {
                            return;
    ...
    private void showSettingWallpaperProgressDialog() {
        ...
        if (!mTestingMode) {
            mSetWallpaperProgressDialog = new ProgressDialog(this, R.style.LightDialogTheme);
    ...
    private static class FetchThumbAssetTask extends AsyncTask<Void, Void, Asset> {
        ...
        private final AssetReceiver mReceiver;
