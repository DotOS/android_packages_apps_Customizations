...
/**
 * Interface for activities that launch an Android customization image picker.
 */
public interface MyPhotosStarter {

    /**
     * Requests that this Activity show the Android customization photo picker for the sake of picking a
