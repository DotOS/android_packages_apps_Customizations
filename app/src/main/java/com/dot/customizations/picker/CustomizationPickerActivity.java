...
import static com.dot.customizations.util.ActivityUtils.isSUWMode;
import static com.dot.customizations.util.ActivityUtils.isWallpaperOnlyMode;
...
public class CustomizationPickerActivity extends FragmentActivity implements AppbarFragmentHost,
    ...
    public void onBackPressed() {
        ...
        if (fragment instanceof ExtrasFragment
                && ((ExtrasFragment) fragment).onBackPressed()) {
            return;
        }
