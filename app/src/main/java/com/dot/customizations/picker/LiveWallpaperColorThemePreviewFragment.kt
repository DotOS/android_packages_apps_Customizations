...
class LiveWallpaperColorThemePreviewFragment : LivePreviewFragment(), WallpaperColorThemePreview {
    ...
    override fun onWallpaperColorsChanged(wallpaperColors: WallpaperColors, i: Int) {
        if (mIgnoreInitialColorChange) {
            ...
            updateSystemBarColor(requireContext())
            ...
            val lockScreenPreviewer =
                LockScreenPreviewer(lifecycle, requireContext(), mLockPreviewContainer)
