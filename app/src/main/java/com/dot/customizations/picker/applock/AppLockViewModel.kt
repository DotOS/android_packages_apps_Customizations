...
import com.dot.customizations.picker.extras.fragmentPreference
...
class AppLockViewModel(app: Application) : AndroidViewModel(app) {
    ...
    fun createSettingsScreen(context: Context) = screen(context) {
        ...
        navigationController?.let {
            ...
            fragmentPreference(it, AppLockPickFragment.newInstance(context.getString(R.string.app_lock_packages_title), it, object : AppLockPickFragment.PickerCallback {
            ...
            fragmentPreference(it, AppLockPickFragment.newInstance(context.getString(R.string.app_lock_notifications_title), it, object : AppLockPickFragment.PickerCallback {
                override val sourceComparator: List<String>
