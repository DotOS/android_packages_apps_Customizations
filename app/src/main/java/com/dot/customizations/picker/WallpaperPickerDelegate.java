...
import com.dot.customizations.module.PackageStatusNotifier.PackageStatus;
...
public class WallpaperPickerDelegate implements MyPhotosStarter {
    ...
    /**
     * Requests to show the Android customization photo picker for the sake of picking a
