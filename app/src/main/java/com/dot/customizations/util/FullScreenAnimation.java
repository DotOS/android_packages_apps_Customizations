...
public class FullScreenAnimation {
    ...
    public void placeViews() {
        setViewMargins(R.id.screen_preview_layout,
                getStatusBarHeight() + getAttributeDimension(android.R.attr.actionBarSize),
    ...
    public void startAnimation(boolean toFullScreen) {
        ...
        if (!mScaleIsSet) {
            ...
            HiddenApiBypass.invoke(SurfaceView.class, mWorkspaceSurface, "setEnableSurfaceClipping", true);
