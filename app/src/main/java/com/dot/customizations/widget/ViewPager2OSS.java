 ...
 */
public final class ViewPager2OSS extends ViewGroup {
    ...
    public ViewPager2OSS(@NonNull Context context) {
        super(context);
        initialize(context, null);
    }

    public ViewPager2OSS(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public ViewPager2OSS(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        private final AccessibilityViewCommand mActionPageForward =
                new AccessibilityViewCommand() {
                    ...
                    public boolean perform(@NonNull View view,
                        ...
                        ViewPager2OSS viewPager = (ViewPager2OSS) view;
        ...
        public void onInitialize(@NonNull CompositeOnPageChangeCallback pageChangeEventDispatcher,
            ...
            if (ViewCompat.getImportantForAccessibility(ViewPager2OSS.this)
                    == ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                ViewCompat.setImportantForAccessibility(ViewPager2OSS.this,
        ...
        public void onRvInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
            event.setSource(ViewPager2OSS.this);
        ...
        void updatePageAccessibilityActions() {
            ViewPager2OSS viewPager = ViewPager2OSS.this;
