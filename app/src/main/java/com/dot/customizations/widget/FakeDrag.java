...
/**
 * Provides fake dragging functionality to {@link ViewPager2OSS}.
 */
final class FakeDrag {
    private final ViewPager2OSS mViewPager;
    ...
    FakeDrag(ViewPager2OSS viewPager, ScrollEventAdapter scrollEventAdapter,
    ...
    boolean fakeDragBy(float offsetPxFloat) {
        ...
        boolean isHorizontal = mViewPager.getOrientation() == ViewPager2OSS.ORIENTATION_HORIZONTAL;
