...
public abstract class Asset {
    ...
    public void loadDrawable(final Context context, final ImageView imageView,
        ...
        decodeBitmap(width, height, bitmap -> {
            if (!needsTransition) {
    ...
    public void loadDrawableWithTransition(
        ...
        decodeBitmap(imageViewDimensions.x, imageViewDimensions.y, bitmap -> {
            final Resources resources = context.getResources();

            new CenterCropBitmapTask(bitmap, imageView, newBitmap -> {
                Drawable[] layers = new Drawable[2];
    ...
    public static class CenterCropBitmapTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        private final BitmapReceiver mBitmapReceiver;
